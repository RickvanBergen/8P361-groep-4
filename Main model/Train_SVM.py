...
predict1 = np.expand_dims(np.loadtxt('Main model//Predictions//model13.csv', delimiter=','),axis=1)
predict2 = np.expand_dims(np.loadtxt('Main model//Predictions//model31.csv', delimiter=','),axis=1)
predict3 = np.expand_dims(np.loadtxt('Main model//Predictions//model26.csv', delimiter=','),axis=1)
