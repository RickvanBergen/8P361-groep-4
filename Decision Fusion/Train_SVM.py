...
train_pred5 = np.concatenate((predict1,predict2,predict3,predict4,predict5),axis=1)
train_pred3_98 = np.concatenate((predict1,predict4,predict98),axis=1)

# SVM_model = svm.SVR(C=1, verbose=1, gamma='scale', max_iter= 10000)
...
# modelname = 'models\Combination_mod\\SVC_poly2.sav'
...
# SVM_model.fit(train_pred3,true_labels)
# modelname = 'models\Combination_mod\\SVC_poly3.sav'
# pickle.dump(SVM_model, open(modelname,'wb'))

SVM_model = svm.SVC(kernel='poly', degree=4 ,C=1, verbose=1, gamma='scale', max_iter=10000, probability=True)
SVM_model.fit(train_pred3,true_labels)
modelname = 'models\Combination_mod\\SVC_poly4.sav'
pickle.dump(SVM_model, open(modelname,'wb'))
